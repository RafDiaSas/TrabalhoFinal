...
data class Pessoas(var id: Long = -1, var nome: String, var numeroCC: String, var telefone: String, var infetado: Boolean, var dataDiagnostico: Int, var dataRecuperacao: Int) {
