...
import pt.ipg.trabalhofinal.databinding.FragmentListaPessoasBinding
...
class ListaPessoasFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreateView(
        ...
        DadosApp.fragmentListaPessoas = this
    ...
    fun processaOpcaoMenu(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_nova_pessoa -> {
                navegaNovaPessoa()
                return true
            }
            R.id.action_alterar_pessoa -> {
                navegaAlterarPessoa()
                return true
            }
            R.id.action_eliminar_pessoa-> {
                navegaEliminarPessoa()
                return true
            }
            else->return false
        }
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> {
        return CursorLoader(
            requireContext(),
            ContentProviderCasos.ENDERECO_PESSOAS,
